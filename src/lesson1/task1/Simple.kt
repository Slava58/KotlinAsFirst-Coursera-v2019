 ...
 */
fun seconds(hours: Int, minutes: Int, seconds: Int): Int = seconds + 60 * (minutes + hours * 60 )
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val ratio = (percent + 100) / 100.0
    return initial * ratio * ratio * ratio
}
...
fun numberRevert(number: Int): Int {
  return number / 100 + (number / 10 - (number / 100) * 10) * 10 + (number - (number / 10) * 10) * 100
}
